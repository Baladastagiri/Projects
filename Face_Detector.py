...
face_classifier = cv2.CascadeClassifier(r"d:\Downloads\haarcascade_eye.xml")
# Load the image
...
faces = face_classifier.detectMultiScale(gray, 1.3, 5) #It will try to build Rectangular boxes
